 ...
 * @param {boolean} [cliOptions.silent] - Suppress report output (for batch/multi-repo mode)
 * @param {AsyncIterable} [cliOptions.fileSource] - Custom file source (e.g. GitHub API). If provided, skips local file discovery.
 * @returns {Promise<{ findings: import('./rules/types.js').Finding[], exitCode: number, meta: { filesScanned: number, rulesRun: number, durationMs: number } }>}
 */
