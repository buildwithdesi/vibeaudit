 ...
 * @param {boolean} [cliOptions.silent] - Skip report output (for batch/programmatic use)
 * @param {AsyncIterable} [cliOptions.fileSource] - Custom file source (e.g. GitHub API). If provided, skips local file discovery.
 * @returns {Promise<{ findings: import('./rules/types.js').Finding[], exitCode: number, meta: Object }>}
 */
